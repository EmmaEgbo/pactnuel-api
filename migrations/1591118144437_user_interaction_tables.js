exports.up = async function(knex) {
  await knex.raw("create table if not exists c_user_followed_categories\n" +
  "(\n" +
  ...
  ");");
  await knex.raw("create table if not exists c_user_followed_authors\n" +
  "(\n" +
  "\tID varchar(20) not null\n" +
  "\t\tprimary key,\n" +
  "\tUSER_ID varchar(20) null,\n" +
  ...
  "\t\tforeign key (USER_ID) references c_user (ID)\n" +
  ");");
  await knex.raw("create table if not exists c_user_followed_publication\n" +
  "(\n" +
  "\tID varchar(20) not null\n" +
  "\t\tprimary key,\n" +
  "\tUSER_ID varchar(20) null,\n" +
  ...
  ");\n");
  await knex.raw("create table if not exists c_user_followed_blog\n" +
  "(\n" +
  "\tID varchar(20) not null\n" +
  "\t\tprimary key,\n" +
  "\tUSER_ID varchar(20) null,\n" +
